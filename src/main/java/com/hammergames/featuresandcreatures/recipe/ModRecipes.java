...
public class ModRecipes {
    ...
    public static final RegistryObject<RecipeSerializer<GemCutterRecipe>> GEM_CUTTER_SERIALIZER = SERIALIZERS.register("gem_cutting", () -> GemCutterRecipe.Serializer.INSTANCE);
