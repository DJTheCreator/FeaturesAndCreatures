...
public class GemCutterRecipe implements Recipe<SimpleContainer> {
    ...
    public GemCutterRecipe(ResourceLocation id, ItemStack output, NonNullList<Ingredient> recipeItems) {
        this.id = id;
        this.output = output;
    ...
    public static class Serializer implements RecipeSerializer<GemCutterRecipe> {
        ...
        public static final ResourceLocation ID = new ResourceLocation(FeaturesAndCreatures.MOD_ID,"gem_cutting");

        @Override
        public GemCutterRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new GemCutterRecipe(id, output, inputs);
        }

        @Override
        public GemCutterRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, GemCutterRecipe recipe) {
